...
func TestWrite_AllOK(t *testing.T) {
	...
	transformationResult := trAllGood()

	output := run(inputMessages, mocks, transformationResult)
...
func TestWrite_AllFiltered(t *testing.T) {
	...
	transformationResult := trAllFiltered()
...
func run(input []*models.Message, targetMocks targetMocks, transformationResult transform.TransformationApplyFunction) testOutput {
	...
	f := sourceWriteFunc(&goodTarget, failure, &filterTarget, transformationResult, obs, config)
...
// Simulating transformation result when all data has been successfuly transformed
func trAllGood() transform.TransformationApplyFunction {
...
func trAllFiltered() transform.TransformationApplyFunction {
	return func(m []*models.Message) *models.TransformationResult {
