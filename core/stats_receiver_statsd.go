...
func (s *StatsDStatsReceiver) Send(b *ObserverBuffer) {
	...
	_ = s.client.TimingDuration("max_message_latency", b.MaxMessageLatency, 1.0)
	_ = s.client.TimingDuration("min_message_latency", b.MinMessageLatency, 1.0)
	_ = s.client.TimingDuration("avg_message_latency", b.GetAvgMessageLatency(), 1.0)
}
