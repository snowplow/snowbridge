...
func (b *ObserverBuffer) String() string {
	return fmt.Sprintf("TargetResults:%d,MsgFiltered:%d,MsgSent:%d,MsgFailed:%d,OversizedTargetResults:%d,OversizedMsgSent:%d,OversizedMsgFailed:%d,InvalidTargetResults:%d,InvalidMsgSent:%d,InvalidMsgFailed:%d,MinProcLatency:%d,MaxProcLatency:%d,AvgProcLatency:%d,MinMsgLatency:%d,MaxMsgLatency:%d,AvgMsgLatency:%d,MinTransformLatency:%d,MaxTransformLatency:%d,AvgTransformLatency:%d,MinFilterLatency:%d,MaxFilterLatency:%d,AvgFilterLatency:%d,MinRequestLatency:%d,MaxRequestLatency:%d,AvgRequestLatency:%d,MinE2ELatency:%d,MaxE2ELatency:%d,AvgE2ELatency:%d",
		b.TargetResults,
		b.MsgFiltered,
		b.MsgSent,
		b.MsgFailed,
