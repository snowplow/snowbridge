...
func configFunctionGeneratorWithInterfaces(kinesisClient common.KinesisAPI, dynamodbClient common.DynamoDBAPI, awsAccountID string) func(c *Configuration) (sourceiface.Source, error) {
...
func newKinesisSourceWithInterfaces(
	kinesisClient common.KinesisAPI,
	dynamodbClient common.DynamoDBAPI,
	awsAccountID string,
	concurrentWrites int,
	region string,
	streamName string,
