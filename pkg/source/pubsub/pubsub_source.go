...
func PubsubSourceConfigFunction(c *PubSubSourceConfig) (sourceiface.Source, error) {
...
var PubsubSourceConfigPair = sourceconfig.SourceConfigPair{
	Name:   "pubsub",
	Handle: AdaptPubSubSourceFunc(PubsubSourceConfigFunction),
}
