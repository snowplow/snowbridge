...
type brokenAdapter func(i interface{}) (interface{}, error)
...
func (f brokenAdapter) Create(i interface{}) (interface{}, error) {
	return f(i)
}

func (f brokenAdapter) ProvideDefault() (interface{}, error) {
	// Provide defaults
	cfg := &configuration{}
