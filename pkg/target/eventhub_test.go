...
var mockErr = errors.New("Mock Failure Path")
...
func TestWriteFailure(t *testing.T) {
	...
	// The error string we expect when we have 5 wrapped errors
	// A bit jank. Open to improvements on this.
	expectedErr := `Error writing messages to EventHub: 5 errors occurred:
	* Failed to send message batch to EventHub: Mock Failure Path
	* Failed to send message batch to EventHub: Mock Failure Path
	* Failed to send message batch to EventHub: Mock Failure Path
	* Failed to send message batch to EventHub: Mock Failure Path
	* Failed to send message batch to EventHub: Mock Failure Path
