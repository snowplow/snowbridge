...
func TestSQSTargetDriver_Batcher(t *testing.T) {
	...
	// Test 1: Adding one message to a batch with 9 messages should trigger send
	// Create a current batch with 9 messages (one less than SQS's default max of 10)
	...
	// Create an oversized message (larger than 256KB)
