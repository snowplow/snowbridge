...
func TestNewSpEnrichedFilterFunction(t *testing.T) {
	...
	contextFuncKeep, _ := NewSpEnrichedFilterFunction("contexts_nl_basjes_yauaa_context_1.test1.test2[0].test3==testValue")
	...
	contextFuncKeep, _ = NewSpEnrichedFilterFunction("contexts_nl_basjes_yauaa_context_1.test1.test2[0].test3==1")
	...
	contextFuncKeep, _ = NewSpEnrichedFilterFunction("contexts_nl_basjes_yauaa_context_2.test1.test2[0].test3==testValue")
	...
	eventFilterFunCkeep, _ := NewSpEnrichedFilterFunction("unstruct_event_add_to_cart.sku==item41")
	...
	// event filter success, non-filtered event name
	eventFilterFunCkeep, _ = NewSpEnrichedFilterFunction("unstruct_event.sku==item41")
	...
	eventFilterFunCkeep, _ = NewSpEnrichedFilterFunction("unstruct_event_wrong_name.sku==item41")
	...
	eventFilterFunCkeep, _ = NewSpEnrichedFilterFunction("unstruct_event_wrong_name.ska==item41")
